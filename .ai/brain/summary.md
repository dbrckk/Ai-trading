...
- tests/test_dashboard_persistence.py: 21 symbols
- tests/test_deployment_readiness.py: 17 symbols
- src/ai_trading/dashboard.py: 15 symbols
...
- top-level items retained: 2524
- direct members retained: 1301
- symbol shards: 25
