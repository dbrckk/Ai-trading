            ...
            self.audit.append(
                "multiasset_runtime_step",
                {
                    ...
                    "resilience": {
                        ...
                        "adaptive_policy": {
                            "recovery_confirmations": adaptive_resilience_policy.recovery_confirmations,
                            "cooldown_confirmations": adaptive_resilience_policy.cooldown_confirmations,
                            "halt_recovery_failures": adaptive_resilience_policy.halt_recovery_failures,
                            "halt_recovery_fallback_depth": adaptive_resilience_policy.halt_recovery_fallback_depth,
                            "cautious_exposure_cap": adaptive_resilience_policy.cautious_exposure_cap,
                            "degraded_exposure_cap": adaptive_resilience_policy.degraded_exposure_cap,
                            "recovery_exposure_cap": adaptive_resilience_policy.recovery_exposure_cap,
                            "cooldown_exposure_cap": adaptive_resilience_policy.cooldown_exposure_cap,
                        },
                        "context": {
                            "data_quality": data_quality,
                            "drawdown": current_drawdown,
